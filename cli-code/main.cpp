...
int main(int argc, char *argv[])
{
    ...
    for(int i = 0; i < argc; i++)
    {
        ...
        if(strcmp(argv[i], "--seed") == 0) {
            sfxr_object.Seed = atoi(argv[i+1]);
            i++;
            continue;
        }
...
void print_help(int argc, char* argv[])
{
    ...
    cout << "  [--save SETTINGSFILE]" << endl;
    cout << "  [--export WAVFILE]" << endl;
    cout << endl;
    cout << "You can define the kind of waveform you'd like to use:" << endl;
    cout << "  [--wave-square]" << endl;
    cout << "  [--wave-sawtooth]" << endl;
    cout << "  [--wave-sine]" << endl;
    cout << "  [--wave-noise]" << endl;
    cout << endl;
    cout << "In addition, you can generate a noise from a prototype:" << endl;
    cout << "  [--generate-pickup]" << endl;
    cout << "  [--generate-laser]" << endl;
    cout << "  [--generate-explosion]" << endl;
    cout << "  [--generate-powerup]" << endl;
    cout << "  [--generate-hit]" << endl;
    cout << "  [--generate-jump]" << endl;
    cout << "  [--generate-blip]" << endl;
    cout << endl;
